...
N_voter = 7; voters = []; N_test = -1; test_list = []
start = 0
# 5,6,7,10,11,12,14 -> 7 voters
must = [5,6,7,10,11,12,14]
...
pd.DataFrame(csv_content, columns=['Image', 'Id']).to_csv('predict/final_predict.csv', index=False)
